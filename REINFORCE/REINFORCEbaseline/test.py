...
def parse_args():
    ...
    parser.add_argument('--model', default='REINFORCE/REINFORCEbaseline/model_reinforce.mdl', type=str, help='Model path')
    ...
    parser.add_argument('--fine_tuning_params', default='REINFORCE/REINFORCEbaseline/result_REINFORCE.pkl', type=str, help='Path to fine-tuning parameters') 
